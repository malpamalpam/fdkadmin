...
export default function NewPzkTutloPage() {
  ...
  const [form, setForm] = useState({
    ...
    firstNames: "",
    benefEmail: "",
    clientType: "TUTLO_PL" as PzkClientType,
    responsibleWorker: "",
    cooperationEndsAt: "",
  });
  ...
  async function handleSubmit() {
    ...
    try {
      const res = await fetch("/api/pzk", {
        ...
        body: JSON.stringify({ ...form, panel: "PZK_TUTLO" }),
      });
      if (!res.ok) {
      ...
      router.push(`/panel/pzk-tutlo/${created.id}`);
    } catch {
  ...
  return (
    <div className="max-w-xl">
      <div className="mb-6">
        <h1 className="text-xl font-bold text-gray-900">Nowe wypowiedzenie — PZK Tutlo</h1>
      ...
      <div className="bg-white border rounded-xl p-6 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            placeholder="np. Przemysław Wróbel"
          />
        </div>
        <div>
